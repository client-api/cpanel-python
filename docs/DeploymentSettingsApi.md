# clientapi_cpanel.DeploymentSettingsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete**](DeploymentSettingsApi.md#delete) | **GET** /VersionControlDeployment/delete | Delete Git deployment task
[**version_control_deployment_create**](DeploymentSettingsApi.md#version_control_deployment_create) | **GET** /VersionControlDeployment/create | Create Git deployment task
[**version_control_deployment_retrieve**](DeploymentSettingsApi.md#version_control_deployment_retrieve) | **GET** /VersionControlDeployment/retrieve | Return Git deployment task status
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.DeploymentSettingsApi(api_client)
    ...
    try:
        ...
        print("The response of DeploymentSettingsApi->delete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeploymentSettingsApi->delete: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DeploymentSettingsApi->version_control_deployment_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeploymentSettingsApi->version_control_deployment_create: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DeploymentSettingsApi->version_control_deployment_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeploymentSettingsApi->version_control_deployment_retrieve: %s\n" % e)
```
