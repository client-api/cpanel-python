...
**dismissed_merge_candidates** | **List[str]** | An array of objects containing information about service candidates that the system dismissed from merges. | [optional] 
...
**issues** | [**List[InlineResponse200532ResultIssues]**](InlineResponse200532ResultIssues.md) | Information about any issues or problems with the subaccount. | [optional] 
**merge_candidates** | **List[str]** | An array of objects that represents the service accounts that the system could merge for this subaccount. | [optional] 
...
**real_name** | **str** | The name of the subaccount&#39;s user. | [optional] 
**services** | [**InlineResponse200532ResultServices**](InlineResponse200532ResultServices.md) |  | [optional] 
...
**username** | **str** | The username for the subaccount. A username that meets the subaccount name limitations. - Length  64 characters. - Characters  a-z, A-Z, 0-9, dot (.), hyphen (-), underscore (_).  **Note:**  This value does **not** include the domain name. | [optional] 
...
json = "{}"
# create an instance of InlineResponse200532ResultData from a JSON string
inline_response200532_result_data_instance = InlineResponse200532ResultData.from_json(json)
# print the JSON string representation of the object
print(InlineResponse200532ResultData.to_json())

# convert the object into a dict
inline_response200532_result_data_dict = inline_response200532_result_data_instance.to_dict()
# create an instance of InlineResponse200532ResultData from a dict
inline_response200532_result_data_from_dict = InlineResponse200532ResultData.from_dict(inline_response200532_result_data_dict)
```
