# clientapi_cpanel.DNSInformationApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**d_nsis_alias_available**](DNSInformationApi.md#d_nsis_alias_available) | **GET** /DNS/is_alias_available | Return &#x60;ALIAS&#x60; DNS record availability &amp; resolver
[**dns_lookup**](DNSInformationApi.md#dns_lookup) | **GET** /DNS/lookup | Return domain&#39;s DNS information
[**dns_mass_edit_zone**](DNSInformationApi.md#dns_mass_edit_zone) | **GET** /DNS/mass_edit_zone | Update a DNS zone
[**dns_parse_zone**](DNSInformationApi.md#dns_parse_zone) | **GET** /DNS/parse_zone | Return a parsed DNS zone
[**ensure_domains_reside_only_locally**](DNSInformationApi.md#ensure_domains_reside_only_locally) | **GET** /DNS/ensure_domains_reside_only_locally | Return whether domains only resolve locally
[**has_local_authority**](DNSInformationApi.md#has_local_authority) | **GET** /DNS/has_local_authority | Return whether local DNS server is authoritative
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.DNSInformationApi(api_client)

    try:
        # Return `ALIAS` DNS record availability & resolver
        api_response = api_instance.d_nsis_alias_available()
        print("The response of DNSInformationApi->d_nsis_alias_available:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSInformationApi->d_nsis_alias_available: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSInformationApi->dns_lookup:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSInformationApi->dns_lookup: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSInformationApi->dns_mass_edit_zone:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSInformationApi->dns_mass_edit_zone: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSInformationApi->dns_parse_zone:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSInformationApi->dns_parse_zone: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSInformationApi->ensure_domains_reside_only_locally:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSInformationApi->ensure_domains_reside_only_locally: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSInformationApi->has_local_authority:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSInformationApi->has_local_authority: %s\n" % e)
```
