# clientapi_cpanel.CPanelAddonsCPAddonsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_available_addons**](CPanelAddonsCPAddonsApi.md#get_available_addons) | **GET** /cPAddons/get_available_addons | Return available cPAddons
[**get_instance_settings**](CPanelAddonsCPAddonsApi.md#get_instance_settings) | **GET** /cPAddons/get_instance_settings | Return deployed cPAddons instance&#39;s settings
[**list_addon_instances**](CPanelAddonsCPAddonsApi.md#list_addon_instances) | **GET** /cPAddons/list_addon_instances | Return deployed cPAddons instances
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.CPanelAddonsCPAddonsApi(api_client)

    try:
        # Return available cPAddons
        api_response = api_instance.get_available_addons()
        print("The response of CPanelAddonsCPAddonsApi->get_available_addons:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPanelAddonsCPAddonsApi->get_available_addons: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPanelAddonsCPAddonsApi->get_instance_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPanelAddonsCPAddonsApi->get_instance_settings: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPanelAddonsCPAddonsApi->list_addon_instances:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPanelAddonsCPAddonsApi->list_addon_instances: %s\n" % e)
```
