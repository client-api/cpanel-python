...
**destinations** | [**TraceDeliveryResponseBounceDestinations**](TraceDeliveryResponseBounceDestinations.md) |  | [optional] 
...
json = "{}"
# create an instance of TraceDeliveryResponseBounce from a JSON string
trace_delivery_response_bounce_instance = TraceDeliveryResponseBounce.from_json(json)
# print the JSON string representation of the object
print(TraceDeliveryResponseBounce.to_json())

# convert the object into a dict
trace_delivery_response_bounce_dict = trace_delivery_response_bounce_instance.to_dict()
# create an instance of TraceDeliveryResponseBounce from a dict
trace_delivery_response_bounce_from_dict = TraceDeliveryResponseBounce.from_dict(trace_delivery_response_bounce_dict)
```
