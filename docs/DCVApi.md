# clientapi_cpanel.DCVApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**check_domains_via_dns**](DCVApi.md#check_domains_via_dns) | **POST** /DCV/check_domains_via_dns | Verify domain ownership via DNS
[**check_domains_via_http**](DCVApi.md#check_domains_via_http) | **GET** /DCV/check_domains_via_http | Verify domain ownership via HTTP
[**ensure_domains_can_pass_dcv**](DCVApi.md#ensure_domains_can_pass_dcv) | **GET** /DCV/ensure_domains_can_pass_dcv | Verify domain ownership
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.DCVApi(api_client)
    ...
    try:
        ...
        print("The response of DCVApi->check_domains_via_dns:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DCVApi->check_domains_via_dns: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DCVApi->check_domains_via_http:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DCVApi->check_domains_via_http: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DCVApi->ensure_domains_can_pass_dcv:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DCVApi->ensure_domains_can_pass_dcv: %s\n" % e)
```
