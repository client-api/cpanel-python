# clientapi_cpanel.ChromeApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_dom**](ChromeApi.md#get_dom) | **GET** /Chrome/get_dom | Return cPanel theme header and footer HTML
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.ChromeApi(api_client)
    ...
    try:
        ...
        print("The response of ChromeApi->get_dom:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChromeApi->get_dom: %s\n" % e)
```
