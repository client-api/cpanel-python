# clientapi_cpanel.BoxTrapperApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**blacklist_messages**](BoxTrapperApi.md#blacklist_messages) | **GET** /BoxTrapper/blacklist_messages | Add email address to BoxTrapper blocked senders
[**box_trapper_get_allowlist**](BoxTrapperApi.md#box_trapper_get_allowlist) | **GET** /BoxTrapper/get_allowlist | Return account BoxTrapper allowlist rules
[**box_trapper_get_blocklist**](BoxTrapperApi.md#box_trapper_get_blocklist) | **GET** /BoxTrapper/get_blocklist | Return account BoxTrapper blocklist rules
[**box_trapper_get_ignorelist**](BoxTrapperApi.md#box_trapper_get_ignorelist) | **GET** /BoxTrapper/get_ignorelist | Return account BoxTrapper ignorelist rules
[**box_trapper_set_allowlist**](BoxTrapperApi.md#box_trapper_set_allowlist) | **GET** /BoxTrapper/set_allowlist | Update account BoxTrapper allowlist
[**box_trapper_set_blocklist**](BoxTrapperApi.md#box_trapper_set_blocklist) | **GET** /BoxTrapper/set_blocklist | Update account BoxTrapper blocklist
[**box_trapper_set_ignorelist**](BoxTrapperApi.md#box_trapper_set_ignorelist) | **GET** /BoxTrapper/set_ignorelist | Update account BoxTrapper ignorelist
[**delete_messages**](BoxTrapperApi.md#delete_messages) | **GET** /BoxTrapper/delete_messages | Delete messages in the BoxTrapper queue
[**deliver_messages**](BoxTrapperApi.md#deliver_messages) | **GET** /BoxTrapper/deliver_messages | Send messages in the BoxTrapper queue
[**get_configuration**](BoxTrapperApi.md#get_configuration) | **GET** /BoxTrapper/get_configuration | Return email account&#39;s BoxTrapper configuration
[**get_email_template**](BoxTrapperApi.md#get_email_template) | **GET** /BoxTrapper/get_email_template | Return specified BoxTrapper email template
[**get_forwarders**](BoxTrapperApi.md#get_forwarders) | **GET** /BoxTrapper/get_forwarders | Return all BoxTrapper forwarders
[**get_log**](BoxTrapperApi.md#get_log) | **GET** /BoxTrapper/get_log | Return BoxTrapper log file and contents
[**get_message**](BoxTrapperApi.md#get_message) | **GET** /BoxTrapper/get_message | Return message&#39;s top 200 lines in BoxTrapper queue
[**get_status**](BoxTrapperApi.md#get_status) | **GET** /BoxTrapper/get_status | Return whether email account uses BoxTrapper
[**ignore_messages**](BoxTrapperApi.md#ignore_messages) | **GET** /BoxTrapper/ignore_messages | Add email account to Exim ignore list
[**list_email_templates**](BoxTrapperApi.md#list_email_templates) | **GET** /BoxTrapper/list_email_templates | Return BoxTrapper email templates
[**list_queued_messages**](BoxTrapperApi.md#list_queued_messages) | **GET** /BoxTrapper/list_queued_messages | Return email account&#39;s BoxTrapper queued messages
[**process_messages**](BoxTrapperApi.md#process_messages) | **GET** /BoxTrapper/process_messages | Run a specific BoxTrapper action for a message
[**reset_email_template**](BoxTrapperApi.md#reset_email_template) | **GET** /BoxTrapper/reset_email_template | Restore default BoxTrapper email message template
[**save_configuration**](BoxTrapperApi.md#save_configuration) | **GET** /BoxTrapper/save_configuration | Update email account&#39;s BoxTrapper configuration
[**save_email_template**](BoxTrapperApi.md#save_email_template) | **GET** /BoxTrapper/save_email_template | Save BoxTrapper message template contents
[**set_forwarders**](BoxTrapperApi.md#set_forwarders) | **GET** /BoxTrapper/set_forwarders | Add email address to BoxTrapper forwarders
[**set_status**](BoxTrapperApi.md#set_status) | **GET** /BoxTrapper/set_status | Enable or disable BoxTrapper for email account
[**whitelist_messages**](BoxTrapperApi.md#whitelist_messages) | **GET** /BoxTrapper/whitelist_messages | Add email address to BoxTrapper allowed senders
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.BoxTrapperApi(api_client)
    ...
    try:
        ...
        print("The response of BoxTrapperApi->blacklist_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->blacklist_messages: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->box_trapper_get_allowlist:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->box_trapper_get_allowlist: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->box_trapper_get_blocklist:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->box_trapper_get_blocklist: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->box_trapper_get_ignorelist:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->box_trapper_get_ignorelist: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->box_trapper_set_allowlist:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->box_trapper_set_allowlist: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->box_trapper_set_blocklist:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->box_trapper_set_blocklist: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->box_trapper_set_ignorelist:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->box_trapper_set_ignorelist: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->delete_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->delete_messages: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->deliver_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->deliver_messages: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->get_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->get_configuration: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->get_email_template:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->get_email_template: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->get_forwarders:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->get_forwarders: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->get_log:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->get_log: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->get_message:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->get_message: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->get_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->get_status: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->ignore_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->ignore_messages: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->list_email_templates:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->list_email_templates: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->list_queued_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->list_queued_messages: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->process_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->process_messages: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->reset_email_template:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->reset_email_template: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->save_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->save_configuration: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->save_email_template:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->save_email_template: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->set_forwarders:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->set_forwarders: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->set_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->set_status: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BoxTrapperApi->whitelist_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BoxTrapperApi->whitelist_messages: %s\n" % e)
```
