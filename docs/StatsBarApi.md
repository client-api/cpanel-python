# clientapi_cpanel.StatsBarApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_stats**](StatsBarApi.md#get_stats) | **GET** /StatsBar/get_stats | Return cPanel account statistics
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.StatsBarApi(api_client)
    ...
    try:
        ...
        print("The response of StatsBarApi->get_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StatsBarApi->get_stats: %s\n" % e)
```
