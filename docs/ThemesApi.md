# clientapi_cpanel.ThemesApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_theme_base**](ThemesApi.md#get_theme_base) | **GET** /Themes/get_theme_base | Return current theme
[**themes_list**](ThemesApi.md#themes_list) | **GET** /Themes/list | Return available themes
[**themes_update**](ThemesApi.md#themes_update) | **GET** /Themes/update | Update current theme
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.ThemesApi(api_client)

    try:
        # Return current theme
        api_response = api_instance.get_theme_base()
        print("The response of ThemesApi->get_theme_base:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ThemesApi->get_theme_base: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ThemesApi->themes_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ThemesApi->themes_list: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ThemesApi->themes_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ThemesApi->themes_update: %s\n" % e)
```
