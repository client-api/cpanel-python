# clientapi_cpanel.WebDiskSettingsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**set_permissions**](WebDiskSettingsApi.md#set_permissions) | **GET** /WebDisk/set_permissions | Update Web Disk home directory permissions
[**web_disk_delete_user**](WebDiskSettingsApi.md#web_disk_delete_user) | **GET** /WebDisk/delete_user | Delete Web Disk account
[**web_disk_set_homedir**](WebDiskSettingsApi.md#web_disk_set_homedir) | **GET** /WebDisk/set_homedir | Update Web Disk home directory location
[**web_disk_set_password**](WebDiskSettingsApi.md#web_disk_set_password) | **GET** /WebDisk/set_password | Update Web Disk account password
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.WebDiskSettingsApi(api_client)
    ...
    try:
        ...
        print("The response of WebDiskSettingsApi->set_permissions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebDiskSettingsApi->set_permissions: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WebDiskSettingsApi->web_disk_delete_user:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebDiskSettingsApi->web_disk_delete_user: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WebDiskSettingsApi->web_disk_set_homedir:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebDiskSettingsApi->web_disk_set_homedir: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WebDiskSettingsApi->web_disk_set_password:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebDiskSettingsApi->web_disk_set_password: %s\n" % e)
```
