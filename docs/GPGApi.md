# clientapi_cpanel.GPGApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_keypair**](GPGApi.md#delete_keypair) | **GET** /GPG/delete_keypair | Delete GnuPG key pair
[**export_public_key**](GPGApi.md#export_public_key) | **GET** /GPG/export_public_key | Export GnuPG public key
[**export_secret_key**](GPGApi.md#export_secret_key) | **GET** /GPG/export_secret_key | Export GnuPG secret key
[**generate_key**](GPGApi.md#generate_key) | **GET** /GPG/generate_key | Create GnuPG key
[**import_key**](GPGApi.md#import_key) | **GET** /GPG/import_key | Import GnuPG key
[**list_public_keys**](GPGApi.md#list_public_keys) | **GET** /GPG/list_public_keys | Return current user&#39;s GnuPG public keys
[**list_secret_keys**](GPGApi.md#list_secret_keys) | **GET** /GPG/list_secret_keys | Return current user&#39;s GnuPG secret keys
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.GPGApi(api_client)
    ...
    try:
        ...
        print("The response of GPGApi->delete_keypair:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GPGApi->delete_keypair: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GPGApi->export_public_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GPGApi->export_public_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GPGApi->export_secret_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GPGApi->export_secret_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GPGApi->generate_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GPGApi->generate_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GPGApi->import_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GPGApi->import_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GPGApi->list_public_keys:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GPGApi->list_public_keys: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GPGApi->list_secret_keys:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GPGApi->list_secret_keys: %s\n" % e)
```
