...
**destinations** | [**TraceDeliveryResponseLocalDeliveryDestinations**](TraceDeliveryResponseLocalDeliveryDestinations.md) |  | [optional] 
...
json = "{}"
# create an instance of TraceDeliveryResponseLocalDelivery from a JSON string
trace_delivery_response_local_delivery_instance = TraceDeliveryResponseLocalDelivery.from_json(json)
# print the JSON string representation of the object
print(TraceDeliveryResponseLocalDelivery.to_json())

# convert the object into a dict
trace_delivery_response_local_delivery_dict = trace_delivery_response_local_delivery_instance.to_dict()
# create an instance of TraceDeliveryResponseLocalDelivery from a dict
trace_delivery_response_local_delivery_from_dict = TraceDeliveryResponseLocalDelivery.from_dict(trace_delivery_response_local_delivery_dict)
```
