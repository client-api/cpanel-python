# clientapi_cpanel.DomainStatisticsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_bandwidth**](DomainStatisticsApi.md#get_bandwidth) | **GET** /Stats/get_bandwidth | Return bandwidth statistics for all domains
[**get_site_errors**](DomainStatisticsApi.md#get_site_errors) | **GET** /Stats/get_site_errors | Return specified domain access log
[**list_sites**](DomainStatisticsApi.md#list_sites) | **GET** /Stats/list_sites | Return Analog statistics for all domains
[**list_stats_by_domain**](DomainStatisticsApi.md#list_stats_by_domain) | **GET** /Stats/list_stats_by_domain | Return Analog statistics for specified domain
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.DomainStatisticsApi(api_client)
    ...
    try:
        ...
        print("The response of DomainStatisticsApi->get_bandwidth:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainStatisticsApi->get_bandwidth: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DomainStatisticsApi->get_site_errors:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainStatisticsApi->get_site_errors: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DomainStatisticsApi->list_sites:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainStatisticsApi->list_sites: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DomainStatisticsApi->list_stats_by_domain:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainStatisticsApi->list_stats_by_domain: %s\n" % e)
```
