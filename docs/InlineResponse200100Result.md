...
inline_response200100_result_instance = InlineResponse200100Result.from_json(json)
# print the JSON string representation of the object
print(InlineResponse200100Result.to_json())

# convert the object into a dict
inline_response200100_result_dict = inline_response200100_result_instance.to_dict()
# create an instance of InlineResponse200100Result from a dict
inline_response200100_result_from_dict = InlineResponse200100Result.from_dict(inline_response200100_result_dict)
```
