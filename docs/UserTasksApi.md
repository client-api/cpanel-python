# clientapi_cpanel.UserTasksApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**retrieve**](UserTasksApi.md#retrieve) | **GET** /UserTasks/retrieve | Return task queue information
[**user_tasks_delete**](UserTasksApi.md#user_tasks_delete) | **GET** /UserTasks/delete | Remove item from task queue
