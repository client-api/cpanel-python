# clientapi_cpanel.ImageToolsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**convert_file**](ImageToolsApi.md#convert_file) | **GET** /ImageManager/convert_file | Create image with new format
[**create_thumbnails**](ImageToolsApi.md#create_thumbnails) | **GET** /ImageManager/create_thumbnails | Create image thumbnails
[**get_dimensions**](ImageToolsApi.md#get_dimensions) | **GET** /ImageManager/get_dimensions | Return image dimensions
[**resize_image**](ImageToolsApi.md#resize_image) | **GET** /ImageManager/resize_image | Save resized image
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.ImageToolsApi(api_client)
    ...
    try:
        ...
        print("The response of ImageToolsApi->convert_file:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImageToolsApi->convert_file: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ImageToolsApi->create_thumbnails:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImageToolsApi->create_thumbnails: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ImageToolsApi->get_dimensions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImageToolsApi->get_dimensions: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ImageToolsApi->resize_image:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImageToolsApi->resize_image: %s\n" % e)
```
