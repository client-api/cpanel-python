# clientapi_cpanel.SubaccountManagementApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**check_account_conflicts**](SubaccountManagementApi.md#check_account_conflicts) | **GET** /UserManager/check_account_conflicts | Return Subaccounts and service accounts conflicts
[**dismiss_merge**](SubaccountManagementApi.md#dismiss_merge) | **GET** /UserManager/dismiss_merge | Remove service account link request
[**edit_user**](SubaccountManagementApi.md#edit_user) | **GET** /UserManager/edit_user | Update Subaccount settings
[**lookup_service_account**](SubaccountManagementApi.md#lookup_service_account) | **GET** /UserManager/lookup_service_account | Return service account&#39;s information
[**lookup_user**](SubaccountManagementApi.md#lookup_user) | **GET** /UserManager/lookup_user | Return Subaccount&#39;s information
[**merge_service_account**](SubaccountManagementApi.md#merge_service_account) | **GET** /UserManager/merge_service_account | Register service account to Subaccount
[**unlink_service_account**](SubaccountManagementApi.md#unlink_service_account) | **GET** /UserManager/unlink_service_account | Unregister service account from Subaccount
[**user_manager_create_user**](SubaccountManagementApi.md#user_manager_create_user) | **GET** /UserManager/create_user | Create Subaccount
[**user_manager_delete_user**](SubaccountManagementApi.md#user_manager_delete_user) | **GET** /UserManager/delete_user | Delete Subaccount
[**user_manager_list_users**](SubaccountManagementApi.md#user_manager_list_users) | **GET** /UserManager/list_users | Return cPanel account&#39;s Subaccounts
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.SubaccountManagementApi(api_client)
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->check_account_conflicts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->check_account_conflicts: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->dismiss_merge:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->dismiss_merge: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->edit_user:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->edit_user: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->lookup_service_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->lookup_service_account: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->lookup_user:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->lookup_user: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->merge_service_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->merge_service_account: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->unlink_service_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->unlink_service_account: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->user_manager_create_user:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->user_manager_create_user: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->user_manager_delete_user:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->user_manager_delete_user: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SubaccountManagementApi->user_manager_list_users:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubaccountManagementApi->user_manager_list_users: %s\n" % e)
```
