# clientapi_cpanel.DAVApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**c_pdavd_add_delegate**](DAVApi.md#c_pdavd_add_delegate) | **GET** /CPDAVD/add_delegate | Share a calendar
[**c_pdavd_list_delegates**](DAVApi.md#c_pdavd_list_delegates) | **GET** /CPDAVD/list_delegates | List calendar sharing.
[**c_pdavd_list_users**](DAVApi.md#c_pdavd_list_users) | **GET** /CPDAVD/list_users | Update calendar sharing
[**c_pdavd_manage_collection**](DAVApi.md#c_pdavd_manage_collection) | **GET** /CPDAVD/manage_collection | Perform an operation on a calendar or address book.
[**c_pdavd_remove_delegate**](DAVApi.md#c_pdavd_remove_delegate) | **GET** /CPDAVD/remove_delegate | Remove a share.
[**c_pdavd_update_delegate**](DAVApi.md#c_pdavd_update_delegate) | **GET** /CPDAVD/update_delegate | Update calendar sharing.
[**disable_shared_global_addressbook**](DAVApi.md#disable_shared_global_addressbook) | **GET** /DAV/disable_shared_global_addressbook | Disable global address book
[**enable_shared_global_addressbook**](DAVApi.md#enable_shared_global_addressbook) | **GET** /DAV/enable_shared_global_addressbook | Enable global address book
[**get_calendar_contacts_config**](DAVApi.md#get_calendar_contacts_config) | **GET** /DAV/get_calendar_contacts_config | Return CalDAV and CardDAV connection information
[**has_shared_global_addressbook**](DAVApi.md#has_shared_global_addressbook) | **GET** /DAV/has_shared_global_addressbook | Return whether global address book is enabled
[**is_dav_service_enabled**](DAVApi.md#is_dav_service_enabled) | **GET** /DAV/is_dav_service_enabled | Return whether DAV is enabled
[**is_horde_enabled**](DAVApi.md#is_horde_enabled) | **GET** /DAV/is_horde_enabled | Return whether Horde is enabled
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.DAVApi(api_client)
    ...
    try:
        ...
        print("The response of DAVApi->c_pdavd_add_delegate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->c_pdavd_add_delegate: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->c_pdavd_list_delegates:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->c_pdavd_list_delegates: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->c_pdavd_list_users:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->c_pdavd_list_users: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->c_pdavd_manage_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->c_pdavd_manage_collection: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->c_pdavd_remove_delegate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->c_pdavd_remove_delegate: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->c_pdavd_update_delegate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->c_pdavd_update_delegate: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->disable_shared_global_addressbook:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->disable_shared_global_addressbook: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->enable_shared_global_addressbook:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->enable_shared_global_addressbook: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->get_calendar_contacts_config:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->get_calendar_contacts_config: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->has_shared_global_addressbook:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->has_shared_global_addressbook: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->is_dav_service_enabled:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->is_dav_service_enabled: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DAVApi->is_horde_enabled:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DAVApi->is_horde_enabled: %s\n" % e)
```
