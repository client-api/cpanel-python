...
**destinations** | [**TraceDeliveryResponseDiscardDestinations**](TraceDeliveryResponseDiscardDestinations.md) |  | [optional] 
...
json = "{}"
# create an instance of TraceDeliveryResponseDiscard from a JSON string
trace_delivery_response_discard_instance = TraceDeliveryResponseDiscard.from_json(json)
# print the JSON string representation of the object
print(TraceDeliveryResponseDiscard.to_json())

# convert the object into a dict
trace_delivery_response_discard_dict = trace_delivery_response_discard_instance.to_dict()
# create an instance of TraceDeliveryResponseDiscard from a dict
trace_delivery_response_discard_from_dict = TraceDeliveryResponseDiscard.from_dict(trace_delivery_response_discard_dict)
```
