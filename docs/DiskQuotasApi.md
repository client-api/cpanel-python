# clientapi_cpanel.DiskQuotasApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_local_quota_info**](DiskQuotasApi.md#get_local_quota_info) | **GET** /Quota/get_local_quota_info | Return local disk quota information
[**get_quota_info**](DiskQuotasApi.md#get_quota_info) | **GET** /Quota/get_quota_info | Return disk quota information
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.DiskQuotasApi(api_client)

    try:
        # Return local disk quota information
        api_response = api_instance.get_local_quota_info()
        print("The response of DiskQuotasApi->get_local_quota_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiskQuotasApi->get_local_quota_info: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DiskQuotasApi->get_quota_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiskQuotasApi->get_quota_info: %s\n" % e)
```
