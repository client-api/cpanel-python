# clientapi_cpanel.WebVhostsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_ssl_capable_domains**](WebVhostsApi.md#list_ssl_capable_domains) | **GET** /WebVhosts/list_ssl_capable_domains | Return domains that allow SSL certificate purchase
[**web_vhosts_list_domains**](WebVhostsApi.md#web_vhosts_list_domains) | **GET** /WebVhosts/list_domains | Return virtual host names for domains
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.WebVhostsApi(api_client)

    try:
        # Return domains that allow SSL certificate purchase
        api_response = api_instance.list_ssl_capable_domains()
        print("The response of WebVhostsApi->list_ssl_capable_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebVhostsApi->list_ssl_capable_domains: %s\n" % e)
```
...
[**InlineResponse200554**](InlineResponse200554.md)
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WebVhostsApi->web_vhosts_list_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebVhostsApi->web_vhosts_list_domains: %s\n" % e)
```
...
[**InlineResponse200553**](InlineResponse200553.md)
