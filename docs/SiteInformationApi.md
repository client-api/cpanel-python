# clientapi_cpanel.SiteInformationApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**word_press_site_retrieve**](SiteInformationApi.md#word_press_site_retrieve) | **GET** /WordPressSite/retrieve | Return WordPress site information
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.SiteInformationApi(api_client)

    try:
        # Return WordPress site information
        api_response = api_instance.word_press_site_retrieve()
        print("The response of SiteInformationApi->word_press_site_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SiteInformationApi->word_press_site_retrieve: %s\n" % e)
```
