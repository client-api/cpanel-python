...
**type** | **str** | The type of domain:  * &#x60;addon_domain&#x60; — The domain is an addon domain. * &#x60;sub_domain&#x60; — The domain is a subdomain. * &#x60;parked_domain&#x60; — The domain is a parked domain (domain alias). | [optional] 
...
json = "{}"
# create an instance of ListOutput from a JSON string
list_output_instance = ListOutput.from_json(json)
# print the JSON string representation of the object
print(ListOutput.to_json())

# convert the object into a dict
list_output_dict = list_output_instance.to_dict()
# create an instance of ListOutput from a dict
list_output_from_dict = ListOutput.from_dict(list_output_dict)
```
