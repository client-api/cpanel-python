# clientapi_cpanel.APITokenManagementApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_full_access**](APITokenManagementApi.md#create_full_access) | **GET** /Tokens/create_full_access | Create cPanel API token
[**rename**](APITokenManagementApi.md#rename) | **GET** /Tokens/rename | Update cPanel API token&#39;s name
[**revoke**](APITokenManagementApi.md#revoke) | **GET** /Tokens/revoke | Remove cPanel API token
[**tokens_list**](APITokenManagementApi.md#tokens_list) | **GET** /Tokens/list | Return cPanel API tokens
