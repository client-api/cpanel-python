...
json = "{}"
# create an instance of LookupServiceAccountSubaccountBase from a JSON string
lookup_service_account_subaccount_base_instance = LookupServiceAccountSubaccountBase.from_json(json)
# print the JSON string representation of the object
print(LookupServiceAccountSubaccountBase.to_json())

# convert the object into a dict
lookup_service_account_subaccount_base_dict = lookup_service_account_subaccount_base_instance.to_dict()
# create an instance of LookupServiceAccountSubaccountBase from a dict
lookup_service_account_subaccount_base_from_dict = LookupServiceAccountSubaccountBase.from_dict(lookup_service_account_subaccount_base_dict)
```
