# clientapi_cpanel.TwoFactorSettingsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**generate_user_configuration**](TwoFactorSettingsApi.md#generate_user_configuration) | **GET** /TwoFactorAuth/generate_user_configuration | Create 2FA authentication code
[**get_team_user_configuration**](TwoFactorSettingsApi.md#get_team_user_configuration) | **GET** /TwoFactorAuth/get_team_user_configuration | Return team user 2FA config
[**get_user_configuration**](TwoFactorSettingsApi.md#get_user_configuration) | **GET** /TwoFactorAuth/get_user_configuration | Return cPanel account 2FA config
[**remove_user_configuration**](TwoFactorSettingsApi.md#remove_user_configuration) | **GET** /TwoFactorAuth/remove_user_configuration | Remove 2FA config
[**set_user_configuration**](TwoFactorSettingsApi.md#set_user_configuration) | **GET** /TwoFactorAuth/set_user_configuration | Save 2FA config
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.TwoFactorSettingsApi(api_client)

    try:
        # Create 2FA authentication code
        api_response = api_instance.generate_user_configuration()
        print("The response of TwoFactorSettingsApi->generate_user_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TwoFactorSettingsApi->generate_user_configuration: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TwoFactorSettingsApi->get_team_user_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TwoFactorSettingsApi->get_team_user_configuration: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TwoFactorSettingsApi->get_user_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TwoFactorSettingsApi->get_user_configuration: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TwoFactorSettingsApi->remove_user_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TwoFactorSettingsApi->remove_user_configuration: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TwoFactorSettingsApi->set_user_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TwoFactorSettingsApi->set_user_configuration: %s\n" % e)
```
