...
------------ | ------------- | ------------- | -------------
**dismissed_merge_candidates** | [**List[LookupServiceAccountSubaccountMergeCandidates]**](LookupServiceAccountSubaccountMergeCandidates.md) | An array of objects of service candidates that the system dismissed from merges. | [optional] 
...
json = "{}"
# create an instance of InlineResponse200533ResultData from a JSON string
inline_response200533_result_data_instance = InlineResponse200533ResultData.from_json(json)
# print the JSON string representation of the object
print(InlineResponse200533ResultData.to_json())

# convert the object into a dict
inline_response200533_result_data_dict = inline_response200533_result_data_instance.to_dict()
# create an instance of InlineResponse200533ResultData from a dict
inline_response200533_result_data_from_dict = InlineResponse200533ResultData.from_dict(inline_response200533_result_data_dict)
```
