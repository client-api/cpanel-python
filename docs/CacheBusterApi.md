# clientapi_cpanel.CacheBusterApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**cache_buster_read**](CacheBusterApi.md#cache_buster_read) | **GET** /CacheBuster/read | Return web browser cached file override ID
[**update**](CacheBusterApi.md#update) | **GET** /CacheBuster/update | Create web browser cached file override ID
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.CacheBusterApi(api_client)

    try:
        # Return web browser cached file override ID
        api_response = api_instance.cache_buster_read()
        print("The response of CacheBusterApi->cache_buster_read:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CacheBusterApi->cache_buster_read: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CacheBusterApi->update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CacheBusterApi->update: %s\n" % e)
```
