# clientapi_cpanel.AntivirusProtectionClamAVApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**clam_scanner_check_disinfection_status**](AntivirusProtectionClamAVApi.md#clam_scanner_check_disinfection_status) | **GET** /ClamScanner/check_disinfection_status | Request disinfection process status
[**clam_scanner_get_scan_paths**](AntivirusProtectionClamAVApi.md#clam_scanner_get_scan_paths) | **GET** /ClamScanner/get_scan_paths | Return virus scan types
[**clam_scanner_get_scan_status**](AntivirusProtectionClamAVApi.md#clam_scanner_get_scan_status) | **GET** /ClamScanner/get_scan_status | Request virus scan status
[**clam_scanner_list_infected_files**](AntivirusProtectionClamAVApi.md#clam_scanner_list_infected_files) | **GET** /ClamScanner/list_infected_files | Return infected file list
[**clam_scanner_start_scan**](AntivirusProtectionClamAVApi.md#clam_scanner_start_scan) | **GET** /ClamScanner/start_scan | Start virus scan
[**disinfect_files**](AntivirusProtectionClamAVApi.md#disinfect_files) | **POST** /ClamScanner/disinfect_files | Start disinfecting files with viruses
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.AntivirusProtectionClamAVApi(api_client)
    ...
    try:
        ...
        print("The response of AntivirusProtectionClamAVApi->clam_scanner_check_disinfection_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AntivirusProtectionClamAVApi->clam_scanner_check_disinfection_status: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AntivirusProtectionClamAVApi->clam_scanner_get_scan_paths:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AntivirusProtectionClamAVApi->clam_scanner_get_scan_paths: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AntivirusProtectionClamAVApi->clam_scanner_get_scan_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AntivirusProtectionClamAVApi->clam_scanner_get_scan_status: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AntivirusProtectionClamAVApi->clam_scanner_list_infected_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AntivirusProtectionClamAVApi->clam_scanner_list_infected_files: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AntivirusProtectionClamAVApi->clam_scanner_start_scan:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AntivirusProtectionClamAVApi->clam_scanner_start_scan: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AntivirusProtectionClamAVApi->disinfect_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AntivirusProtectionClamAVApi->disinfect_files: %s\n" % e)
```
