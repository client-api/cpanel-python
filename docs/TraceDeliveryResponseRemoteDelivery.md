...
**destinations** | [**List[TraceDeliveryResponseRemoteDeliveryDestinations]**](TraceDeliveryResponseRemoteDeliveryDestinations.md) |  | [optional] 
...
json = "{}"
# create an instance of TraceDeliveryResponseRemoteDelivery from a JSON string
trace_delivery_response_remote_delivery_instance = TraceDeliveryResponseRemoteDelivery.from_json(json)
# print the JSON string representation of the object
print(TraceDeliveryResponseRemoteDelivery.to_json())

# convert the object into a dict
trace_delivery_response_remote_delivery_dict = trace_delivery_response_remote_delivery_instance.to_dict()
# create an instance of TraceDeliveryResponseRemoteDelivery from a dict
trace_delivery_response_remote_delivery_from_dict = TraceDeliveryResponseRemoteDelivery.from_dict(trace_delivery_response_remote_delivery_dict)
```
