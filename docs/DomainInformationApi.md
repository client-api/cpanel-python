# clientapi_cpanel.DomainInformationApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**domains_data**](DomainInformationApi.md#domains_data) | **GET** /DomainInfo/domains_data | Return all domains&#39; hosting configuration
[**list_domains**](DomainInformationApi.md#list_domains) | **GET** /DomainInfo/list_domains | Return cPanel account&#39;s domains
[**main_domain_builtin_subdomain_aliases**](DomainInformationApi.md#main_domain_builtin_subdomain_aliases) | **GET** /DomainInfo/main_domain_builtin_subdomain_aliases | Return built-in subdomain aliases
[**single_domain_data**](DomainInformationApi.md#single_domain_data) | **GET** /DomainInfo/single_domain_data | Return domain&#39;s hosting configuration
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.DomainInformationApi(api_client)
    ...
    try:
        ...
        print("The response of DomainInformationApi->domains_data:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainInformationApi->domains_data: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DomainInformationApi->list_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainInformationApi->list_domains: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DomainInformationApi->main_domain_builtin_subdomain_aliases:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainInformationApi->main_domain_builtin_subdomain_aliases: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DomainInformationApi->single_domain_data:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainInformationApi->single_domain_data: %s\n" % e)
```
