# clientapi_cpanel.CPanelFeaturesApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_feature_metadata**](CPanelFeaturesApi.md#get_feature_metadata) | **GET** /Features/get_feature_metadata | Return cPanel account&#39;s features&#39; metadata
[**has_feature**](CPanelFeaturesApi.md#has_feature) | **GET** /Features/has_feature | Validate cPanel account&#39;s feature access
[**list_features**](CPanelFeaturesApi.md#list_features) | **GET** /Features/list_features | Return cPanel account&#39;s features
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.CPanelFeaturesApi(api_client)

    try:
        # Return cPanel account's features' metadata
        api_response = api_instance.get_feature_metadata()
        print("The response of CPanelFeaturesApi->get_feature_metadata:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPanelFeaturesApi->get_feature_metadata: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPanelFeaturesApi->has_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPanelFeaturesApi->has_feature: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPanelFeaturesApi->list_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPanelFeaturesApi->list_features: %s\n" % e)
```
