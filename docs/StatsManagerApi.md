# clientapi_cpanel.StatsManagerApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**stats_manager_get_configuration**](StatsManagerApi.md#stats_manager_get_configuration) | **GET** /StatsManager/get_configuration | Returns weblog analyzers&#39; configuration
[**stats_manager_save_configuration**](StatsManagerApi.md#stats_manager_save_configuration) | **POST** /StatsManager/save_configuration | Save current user&#39;s weblog analyzers configuration
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.StatsManagerApi(api_client)

    try:
        # Returns weblog analyzers' configuration
        api_response = api_instance.stats_manager_get_configuration()
        print("The response of StatsManagerApi->stats_manager_get_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StatsManagerApi->stats_manager_get_configuration: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StatsManagerApi->stats_manager_save_configuration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StatsManagerApi->stats_manager_save_configuration: %s\n" % e)
```
