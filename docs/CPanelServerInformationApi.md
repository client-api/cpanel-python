# clientapi_cpanel.CPanelServerInformationApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_information**](CPanelServerInformationApi.md#get_information) | **GET** /ServerInformation/get_information | Return service and device status
[**variables_get_server_information**](CPanelServerInformationApi.md#variables_get_server_information) | **GET** /Variables/get_server_information | Return server&#39;s configuration settings
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.CPanelServerInformationApi(api_client)

    try:
        # Return service and device status
        api_response = api_instance.get_information()
        print("The response of CPanelServerInformationApi->get_information:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPanelServerInformationApi->get_information: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPanelServerInformationApi->variables_get_server_information:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPanelServerInformationApi->variables_get_server_information: %s\n" % e)
```
