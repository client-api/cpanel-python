...
**signature_algorithm** | **str** | The certificate&#39;s OID signature hash algorithm. | [optional] 
...
json = "{}"
# create an instance of InlineResponse200405ResultData from a JSON string
inline_response200405_result_data_instance = InlineResponse200405ResultData.from_json(json)
# print the JSON string representation of the object
print(InlineResponse200405ResultData.to_json())

# convert the object into a dict
inline_response200405_result_data_dict = inline_response200405_result_data_instance.to_dict()
# create an instance of InlineResponse200405ResultData from a dict
inline_response200405_result_data_from_dict = InlineResponse200405ResultData.from_dict(inline_response200405_result_data_dict)
```
