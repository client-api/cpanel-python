...
**destinations** | [**TraceDeliveryResponseErrorDestinations**](TraceDeliveryResponseErrorDestinations.md) |  | [optional] 
...
json = "{}"
# create an instance of TraceDeliveryResponseError from a JSON string
trace_delivery_response_error_instance = TraceDeliveryResponseError.from_json(json)
# print the JSON string representation of the object
print(TraceDeliveryResponseError.to_json())

# convert the object into a dict
trace_delivery_response_error_dict = trace_delivery_response_error_instance.to_dict()
# create an instance of TraceDeliveryResponseError from a dict
trace_delivery_response_error_from_dict = TraceDeliveryResponseError.from_dict(trace_delivery_response_error_dict)
```
