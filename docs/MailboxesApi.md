# clientapi_cpanel.MailboxesApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**expunge_mailbox_messages**](MailboxesApi.md#expunge_mailbox_messages) | **GET** /Mailboxes/expunge_mailbox_messages | Delete selected messages in mailbox
[**expunge_messages_for_mailbox_guid**](MailboxesApi.md#expunge_messages_for_mailbox_guid) | **GET** /Mailboxes/expunge_messages_for_mailbox_guid | Delete selected messages in mailbox by GUID
[**get_mailbox_status_list**](MailboxesApi.md#get_mailbox_status_list) | **GET** /Mailboxes/get_mailbox_status_list | Return cPanel account&#39;s mailbox status
[**has_utf8_mailbox_names**](MailboxesApi.md#has_utf8_mailbox_names) | **GET** /Mailboxes/has_utf8_mailbox_names | Return if cPanel account&#39;s mailboxes use UTF-8
[**set_utf8_mailbox_names**](MailboxesApi.md#set_utf8_mailbox_names) | **GET** /Mailboxes/set_utf8_mailbox_names | Enable or disable Webmail mailbox UTF-8 encoding
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.MailboxesApi(api_client)
    ...
    try:
        ...
        print("The response of MailboxesApi->expunge_mailbox_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MailboxesApi->expunge_mailbox_messages: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MailboxesApi->expunge_messages_for_mailbox_guid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MailboxesApi->expunge_messages_for_mailbox_guid: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MailboxesApi->get_mailbox_status_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MailboxesApi->get_mailbox_status_list: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MailboxesApi->has_utf8_mailbox_names:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MailboxesApi->has_utf8_mailbox_names: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MailboxesApi->set_utf8_mailbox_names:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MailboxesApi->set_utf8_mailbox_names: %s\n" % e)
```
