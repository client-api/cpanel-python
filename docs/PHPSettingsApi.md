# clientapi_cpanel.PHPSettingsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**php_get_domain_handler**](PHPSettingsApi.md#php_get_domain_handler) | **GET** /LangPHP/php_get_domain_handler | Return PHP version&#39;s handler
[**php_get_impacted_domains**](PHPSettingsApi.md#php_get_impacted_domains) | **GET** /LangPHP/php_get_impacted_domains | Return domains that shared PHP configuration
[**php_get_installed_versions**](PHPSettingsApi.md#php_get_installed_versions) | **GET** /LangPHP/php_get_installed_versions | Return installed PHP versions
[**php_get_system_default_version**](PHPSettingsApi.md#php_get_system_default_version) | **GET** /LangPHP/php_get_system_default_version | Return default PHP version
[**php_get_vhost_versions**](PHPSettingsApi.md#php_get_vhost_versions) | **GET** /LangPHP/php_get_vhost_versions | Return virtual host&#39;s PHP version
[**php_ini_get_user_basic_directives**](PHPSettingsApi.md#php_ini_get_user_basic_directives) | **GET** /LangPHP/php_ini_get_user_basic_directives | Return basic PHP directives
[**php_ini_get_user_content**](PHPSettingsApi.md#php_ini_get_user_content) | **GET** /LangPHP/php_ini_get_user_content | Return virtual host&#39;s php.ini content
[**php_ini_get_user_paths**](PHPSettingsApi.md#php_ini_get_user_paths) | **GET** /LangPHP/php_ini_get_user_paths | Return php.ini file paths
[**php_ini_set_user_basic_directives**](PHPSettingsApi.md#php_ini_set_user_basic_directives) | **GET** /LangPHP/php_ini_set_user_basic_directives | Update basic PHP directives
[**php_ini_set_user_content**](PHPSettingsApi.md#php_ini_set_user_content) | **GET** /LangPHP/php_ini_set_user_content | Update virtual host&#39;s php.ini content
[**php_set_vhost_versions**](PHPSettingsApi.md#php_set_vhost_versions) | **GET** /LangPHP/php_set_vhost_versions | Update virtual host&#39;s PHP version
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.PHPSettingsApi(api_client)
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_get_domain_handler:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_get_domain_handler: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_get_impacted_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_get_impacted_domains: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_get_installed_versions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_get_installed_versions: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_get_system_default_version:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_get_system_default_version: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_get_vhost_versions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_get_vhost_versions: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_ini_get_user_basic_directives:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_ini_get_user_basic_directives: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_ini_get_user_content:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_ini_get_user_content: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_ini_get_user_paths:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_ini_get_user_paths: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_ini_set_user_basic_directives:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_ini_set_user_basic_directives: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_ini_set_user_content:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_ini_set_user_content: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PHPSettingsApi->php_set_vhost_versions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PHPSettingsApi->php_set_vhost_versions: %s\n" % e)
```
