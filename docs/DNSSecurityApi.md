# clientapi_cpanel.DNSSecurityApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**activate_zone_key**](DNSSecurityApi.md#activate_zone_key) | **GET** /DNSSEC/activate_zone_key | Enable DNSSEC security key
[**add_zone_key**](DNSSecurityApi.md#add_zone_key) | **GET** /DNSSEC/add_zone_key | Create DNSSEC security key
[**deactivate_zone_key**](DNSSecurityApi.md#deactivate_zone_key) | **GET** /DNSSEC/deactivate_zone_key | Disable DNSSEC security key
[**disable_dnssec**](DNSSecurityApi.md#disable_dnssec) | **GET** /DNSSEC/disable_dnssec | Disable DNSSEC
[**enable_dnssec**](DNSSecurityApi.md#enable_dnssec) | **GET** /DNSSEC/enable_dnssec | Enable DNSSEC
[**export_zone_dnskey**](DNSSecurityApi.md#export_zone_dnskey) | **GET** /DNSSEC/export_zone_dnskey | Export DNSKEY record value
[**export_zone_key**](DNSSecurityApi.md#export_zone_key) | **GET** /DNSSEC/export_zone_key | Export DNSSEC security key
[**fetch_ds_records**](DNSSecurityApi.md#fetch_ds_records) | **GET** /DNSSEC/fetch_ds_records | Return domain&#39;s DS records
[**import_zone_key**](DNSSecurityApi.md#import_zone_key) | **GET** /DNSSEC/import_zone_key | Add DNSSEC security key
[**remove_zone_key**](DNSSecurityApi.md#remove_zone_key) | **GET** /DNSSEC/remove_zone_key | Remove DNSSEC security key
[**set_nsec3**](DNSSecurityApi.md#set_nsec3) | **GET** /DNSSEC/set_nsec3 | Update domain to use NSEC3
[**unset_nsec3**](DNSSecurityApi.md#unset_nsec3) | **GET** /DNSSEC/unset_nsec3 | Update domain to use NSEC
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.DNSSecurityApi(api_client)
    ...
    try:
        ...
        print("The response of DNSSecurityApi->activate_zone_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->activate_zone_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->add_zone_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->add_zone_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->deactivate_zone_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->deactivate_zone_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->disable_dnssec:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->disable_dnssec: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->enable_dnssec:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->enable_dnssec: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->export_zone_dnskey:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->export_zone_dnskey: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->export_zone_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->export_zone_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->fetch_ds_records:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->fetch_ds_records: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->import_zone_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->import_zone_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->remove_zone_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->remove_zone_key: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->set_nsec3:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->set_nsec3: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DNSSecurityApi->unset_nsec3:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DNSSecurityApi->unset_nsec3: %s\n" % e)
```
