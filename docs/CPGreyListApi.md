# clientapi_cpanel.CPGreyListApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**c_p_grey_list_disable_all_domains**](CPGreyListApi.md#c_p_grey_list_disable_all_domains) | **GET** /cPGreyList/disable_all_domains | Disable Greylisting for all domains
[**c_p_grey_list_disable_domains**](CPGreyListApi.md#c_p_grey_list_disable_domains) | **GET** /cPGreyList/disable_domains | Disable Greylisting for specified domains
[**c_p_grey_list_enable_all_domains**](CPGreyListApi.md#c_p_grey_list_enable_all_domains) | **GET** /cPGreyList/enable_all_domains | Enable Greylisting for all domains
[**c_p_grey_list_enable_domains**](CPGreyListApi.md#c_p_grey_list_enable_domains) | **GET** /cPGreyList/enable_domains | Enable Greylisting for specified domains
[**c_p_grey_list_list_domains**](CPGreyListApi.md#c_p_grey_list_list_domains) | **GET** /cPGreyList/list_domains | Return Greylisting status for domains
[**has_greylisting_enabled**](CPGreyListApi.md#has_greylisting_enabled) | **GET** /cPGreyList/has_greylisting_enabled | Return whether Greylisting is enabled
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.CPGreyListApi(api_client)

    try:
        # Disable Greylisting for all domains
        api_response = api_instance.c_p_grey_list_disable_all_domains()
        print("The response of CPGreyListApi->c_p_grey_list_disable_all_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPGreyListApi->c_p_grey_list_disable_all_domains: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPGreyListApi->c_p_grey_list_disable_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPGreyListApi->c_p_grey_list_disable_domains: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPGreyListApi->c_p_grey_list_enable_all_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPGreyListApi->c_p_grey_list_enable_all_domains: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPGreyListApi->c_p_grey_list_enable_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPGreyListApi->c_p_grey_list_enable_domains: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPGreyListApi->c_p_grey_list_list_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPGreyListApi->c_p_grey_list_list_domains: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CPGreyListApi->has_greylisting_enabled:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CPGreyListApi->has_greylisting_enabled: %s\n" % e)
```
