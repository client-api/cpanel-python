# clientapi_cpanel.WebmailApplicationsApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_webmail_apps**](WebmailApplicationsApi.md#list_webmail_apps) | **GET** /WebmailApps/list_webmail_apps | Return available webmail clients
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.WebmailApplicationsApi(api_client)
    ...
    try:
        ...
        print("The response of WebmailApplicationsApi->list_webmail_apps:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebmailApplicationsApi->list_webmail_apps: %s\n" % e)
```
