...
lookup_service_account_subaccount_merge_candidates_merge_candidates_inner_instance = LookupServiceAccountSubaccountMergeCandidatesMergeCandidatesInner.from_json(json)
# print the JSON string representation of the object
print(LookupServiceAccountSubaccountMergeCandidatesMergeCandidatesInner.to_json())

# convert the object into a dict
lookup_service_account_subaccount_merge_candidates_merge_candidates_inner_dict = lookup_service_account_subaccount_merge_candidates_merge_candidates_inner_instance.to_dict()
# create an instance of LookupServiceAccountSubaccountMergeCandidatesMergeCandidatesInner from a dict
lookup_service_account_subaccount_merge_candidates_merge_candidates_inner_from_dict = LookupServiceAccountSubaccountMergeCandidatesMergeCandidatesInner.from_dict(lookup_service_account_subaccount_merge_candidates_merge_candidates_inner_dict)
```
