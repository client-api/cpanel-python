# clientapi_cpanel.KnownSSHHostsManagementApi

All URIs are relative to *https://cpanel-server.tld:2083/execute*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create**](KnownSSHHostsManagementApi.md#create) | **GET** /KnownHosts/create | Create host
[**known_hosts_delete**](KnownSSHHostsManagementApi.md#known_hosts_delete) | **GET** /KnownHosts/delete | Delete host
[**known_hosts_update**](KnownSSHHostsManagementApi.md#known_hosts_update) | **GET** /KnownHosts/update | Update host in the known_hosts file
[**verify**](KnownSSHHostsManagementApi.md#verify) | **GET** /KnownHosts/verify | Validate host
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_cpanel.KnownSSHHostsManagementApi(api_client)
    ...
    try:
        ...
        print("The response of KnownSSHHostsManagementApi->create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KnownSSHHostsManagementApi->create: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KnownSSHHostsManagementApi->known_hosts_delete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KnownSSHHostsManagementApi->known_hosts_delete: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KnownSSHHostsManagementApi->known_hosts_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KnownSSHHostsManagementApi->known_hosts_update: %s\n" % e)
```
...
with clientapi_cpanel.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KnownSSHHostsManagementApi->verify:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KnownSSHHostsManagementApi->verify: %s\n" % e)
```
