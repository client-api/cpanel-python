...
class TestInlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties(unittest.TestCase):
    """InlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties:
        """Test InlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties`
        """
        model = InlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties()
        if include_optional:
            return InlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties(
                active = 1,
...
Coefficient: mynNLSgStpQMktIEdysefyOg5jpXE3VeDZF6fbEOUg+E2ZnLBkLu4KPrriCwfl+cLagwgzx2M6wV/1QWkm8vPQ=='
    ...
    def testInlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties(self):
        """Test InlineResponse20095ResultDataAdditionalPropertiesKeysAdditionalProperties"""
