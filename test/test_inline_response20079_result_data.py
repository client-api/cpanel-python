...
class TestInlineResponse20079ResultData(unittest.TestCase):
    """InlineResponse20079ResultData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse20079ResultData:
        """Test InlineResponse20079ResultData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse20079ResultData`
        """
        model = InlineResponse20079ResultData()
        if include_optional:
            return InlineResponse20079ResultData(
    ...
    def testInlineResponse20079ResultData(self):
        """Test InlineResponse20079ResultData"""
