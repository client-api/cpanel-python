...
class TestInlineResponse200425ResultDataCertificate(unittest.TestCase):
    """InlineResponse200425ResultDataCertificate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse200425ResultDataCertificate:
        """Test InlineResponse200425ResultDataCertificate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse200425ResultDataCertificate`
        """
        model = InlineResponse200425ResultDataCertificate()
        if include_optional:
            return InlineResponse200425ResultDataCertificate(
                domains = [
                    'example.com'
                    ],
...
example.com',
    ...
    def testInlineResponse200425ResultDataCertificate(self):
        """Test InlineResponse200425ResultDataCertificate"""
