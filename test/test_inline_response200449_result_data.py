...
class TestInlineResponse200449ResultData(unittest.TestCase):
    """InlineResponse200449ResultData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse200449ResultData:
        """Test InlineResponse200449ResultData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse200449ResultData`
        """
        model = InlineResponse200449ResultData()
        if include_optional:
            return InlineResponse200449ResultData(
                created = 1569844800,
                domains = [
                    'example.com'
                    ],
                ...
                is_self_signed = 1,
                issuer_common_name = 'VeriSign Trial Secure Server CA - G2',
                issuer_organization_name = 'VeriSign, Inc.',
    ...
    def testInlineResponse200449ResultData(self):
        """Test InlineResponse200449ResultData"""
