...
class TestInlineResponse200541ResultData(unittest.TestCase):
    """InlineResponse200541ResultData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse200541ResultData:
        """Test InlineResponse200541ResultData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse200541ResultData`
        """
        model = InlineResponse200541ResultData()
        if include_optional:
            return InlineResponse200541ResultData(
                backup_enabled = 1,
                bandwidth_limit = 0,
                cgi_enabled = 1,
    ...
    def testInlineResponse200541ResultData(self):
        """Test InlineResponse200541ResultData"""
