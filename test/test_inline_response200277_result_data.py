...
class TestInlineResponse200277ResultData(unittest.TestCase):
    """InlineResponse200277ResultData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse200277ResultData:
        """Test InlineResponse200277ResultData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse200277ResultData`
        """
        model = InlineResponse200277ResultData()
        if include_optional:
            return InlineResponse200277ResultData(
                host = [
    ...
    def testInlineResponse200277ResultData(self):
        """Test InlineResponse200277ResultData"""
