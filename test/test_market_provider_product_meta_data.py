...
class TestMarketProviderProductMetaData(unittest.TestCase):
    """MarketProviderProductMetaData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketProviderProductMetaData:
        """Test MarketProviderProductMetaData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketProviderProductMetaData`
        """
        model = MarketProviderProductMetaData()
        if include_optional:
            return MarketProviderProductMetaData(
                base_name = '',
    ...
    def testMarketProviderProductMetaData(self):
        """Test MarketProviderProductMetaData"""
