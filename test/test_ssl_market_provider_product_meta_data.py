...
class TestSSLMarketProviderProductMetaData(unittest.TestCase):
    """SSLMarketProviderProductMetaData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSLMarketProviderProductMetaData:
        """Test SSLMarketProviderProductMetaData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSLMarketProviderProductMetaData`
        """
        model = SSLMarketProviderProductMetaData()
        if include_optional:
            return SSLMarketProviderProductMetaData(
                base_name = '',
    ...
    def testSSLMarketProviderProductMetaData(self):
        """Test SSLMarketProviderProductMetaData"""
