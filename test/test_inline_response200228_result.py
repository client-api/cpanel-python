...
class TestInlineResponse200228Result(unittest.TestCase):
    """InlineResponse200228Result unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse200228Result:
        """Test InlineResponse200228Result
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse200228Result`
        """
        model = InlineResponse200228Result()
        if include_optional:
            return InlineResponse200228Result(
                data = [
    ...
    def testInlineResponse200228Result(self):
        """Test InlineResponse200228Result"""
