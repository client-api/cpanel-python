...
class TestInlineResponse200405Result(unittest.TestCase):
    """InlineResponse200405Result unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse200405Result:
        """Test InlineResponse200405Result
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse200405Result`
        """
        model = InlineResponse200405Result()
        if include_optional:
            return InlineResponse200405Result(
                data = [
                    clientapi_cpanel.models.inline_response_200_405_result_data.inline_response_200_405_result_data(
                        created = 1538308800, 
                        domains = [
                            'example.com'
                            ], 
...
www.example.com', 
    ...
    def testInlineResponse200405Result(self):
        """Test InlineResponse200405Result"""
