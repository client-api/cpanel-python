...
class TestInlineResponse20079(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InlineResponse20079:
        """Test InlineResponse20079
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse20079`
        """
        ...
        if include_optional:
            return InlineResponse20079(
                ...
                module = 'DCV',
                result = clientapi_cpanel.models.inline_response_200_79_result.inline_response_200_79_result(
                    data = [
