...
class TestInlineResponse200430(unittest.TestCase):
    """InlineResponse200430 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse200430:
        """Test InlineResponse200430
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse200430`
        """
        model = InlineResponse200430()
        if include_optional:
            return InlineResponse200430(
                apiversion = 3,
                func = 'list_certs',
                module = 'SSL',
                result = clientapi_cpanel.models.inline_response_200_430_result.inline_response_200_430_result(
                    data = [
...
www.example.com', 
    ...
    def testInlineResponse200430(self):
        """Test InlineResponse200430"""
