...
class TestInlineResponse20095Result(unittest.TestCase):
    """InlineResponse20095Result unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineResponse20095Result:
        """Test InlineResponse20095Result
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineResponse20095Result`
        """
        model = InlineResponse20095Result()
        if include_optional:
            return InlineResponse20095Result(
    ...
    def testInlineResponse20095Result(self):
        """Test InlineResponse20095Result"""
