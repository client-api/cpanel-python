...
class InlineResponse200357ResultDataFailures(BaseModel):
    """
    InlineResponse200357ResultDataFailures
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="The error message.")
    host: Optional[StrictStr] = Field(default=None, description="The hostname that reported the error.")
    __properties: ClassVar[List[str]] = ["error", "host"]
