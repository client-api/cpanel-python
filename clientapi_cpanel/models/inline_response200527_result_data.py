...
class InlineResponse200527ResultData(BaseModel):
    """
    InlineResponse200527ResultData
    """ # noqa: E501
    accounts: Optional[InlineResponse200527ResultDataAccounts] = None
    conflict: Optional[StrictInt] = Field(default=None, description="Whether the system detected an account conflict.  * `1` — Conflict. * `0` — **No** conflict.")
    __properties: ClassVar[List[str]] = ["accounts", "conflict"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": InlineResponse200527ResultDataAccounts.from_dict(obj["accounts"]) if obj.get("accounts") is not None else None,
