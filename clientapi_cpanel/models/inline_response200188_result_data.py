...
class InlineResponse200188ResultData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "select": obj.get("select") if obj.get("select") is not None else 1
        })
        return _obj
