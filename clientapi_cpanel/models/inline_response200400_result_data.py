...
class InlineResponse200400ResultData(BaseModel):
    """
    An object containing the status of the operation.
    """ # noqa: E501
    success: Optional[StrictInt] = Field(default=None, description="Whether the `overwrite` parameter succeeded.  * `1` — Success. * `0` — Failure.")
