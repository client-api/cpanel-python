...
class TeamHash(BaseModel):
    """
    TeamHash
    """ # noqa: E501
    owner: Optional[StrictStr] = None
    users: Optional[TeamHashUsers] = None
    __properties: ClassVar[List[str]] = ["owner", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "owner": obj.get("owner"),
            "users": TeamHashUsers.from_dict(obj["users"]) if obj.get("users") is not None else None
        })
        return _obj
