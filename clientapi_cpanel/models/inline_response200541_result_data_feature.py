...
class InlineResponse200541ResultDataFeature(BaseModel):
    """
    ...
    """ # noqa: E501
    additional_properties: Optional[StrictInt] = Field(default=None, description="Whether the feature is enabled. * `1` - Enabled. * `0` - Disabled.  **Note:**  The feature's name is the return name.", alias="additionalProperties")
