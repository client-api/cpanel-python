...
class SSLMarketProviderProductMetaDataXIdentityVerification(BaseModel):
    """
    Defines a schema for identity verification information for OV and EV certificates.
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="The display name of the property.")
