...
class InlineResponse200538ResultArgs(BaseModel):
    """
    ...
    """ # noqa: E501
    repository_root: Optional[StrictStr] = Field(default=None, description="The absolute path to the repostiory's `root` directory.")
    __properties: ClassVar[List[str]] = ["repository_root"]
