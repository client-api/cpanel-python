...
class InlineResponse200546ResultDataTimestamps(BaseModel):
    """
    A hash of timestamps for the deployment process.
    """ # noqa: E501
    queued: Optional[StrictStr] = Field(default=None, description="The time at which the deployment process. entered the task queue.")
