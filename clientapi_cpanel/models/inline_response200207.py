...
class InlineResponse200207(BaseModel):
    """
    InlineResponse200207
    """ # noqa: E501
    metadata: Optional[InlineResponse200207Metadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": InlineResponse200207Metadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
