...
class InlineResponse200314ResultData(BaseModel):
    """
    InlineResponse200314ResultData
    """ # noqa: E501
    error_type: Optional[StrictStr] = Field(default=None, description="Any errors that the function encounters.")
    __properties: ClassVar[List[str]] = ["error_type"]
