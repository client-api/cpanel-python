...
class InlineResponse200535ResultDataServices(BaseModel):
    """
    ...
    webdisk: Optional[InlineResponse200535ResultDataServicesWebdisk] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "webdisk": InlineResponse200535ResultDataServicesWebdisk.from_dict(obj["webdisk"]) if obj.get("webdisk") is not None else None
        })
        return _obj
