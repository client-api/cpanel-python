...
class InlineResponse200286ResultData(BaseModel):
    """
    InlineResponse200286ResultData
    """ # noqa: E501
    paths: Optional[List[InlineResponse200286ResultDataPaths]] = Field(default=None, description="An array of objects of `php.ini` file information.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paths": [InlineResponse200286ResultDataPaths.from_dict(_item) for _item in obj["paths"]] if obj.get("paths") is not None else None
        })
        return _obj
