...
class InlineResponse200113ResultDataIfmodulemodsuphpc(BaseModel):
    """
    An object containing information about PHP scripts and suPHP.
    """ # noqa: E501
    group: Optional[StrictStr] = Field(default=None, description="If suPHP is enabled, the group that PHP scripts run as.")
