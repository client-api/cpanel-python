...
class InlineResponse200527ResultDataAccountsServices(BaseModel):
    """
    Information about the Subaccount's access to email, FTP, and Web Disk.
    """ # noqa: E501
    email: Optional[InlineResponse200527ResultDataAccountsServicesEmail] = None
    ftp: Optional[InlineResponse200527ResultDataAccountsServicesFtp] = None
    webdisk: Optional[InlineResponse200527ResultDataAccountsServicesWebdisk] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": InlineResponse200527ResultDataAccountsServicesEmail.from_dict(obj["email"]) if obj.get("email") is not None else None,
            "ftp": InlineResponse200527ResultDataAccountsServicesFtp.from_dict(obj["ftp"]) if obj.get("ftp") is not None else None,
            "webdisk": InlineResponse200527ResultDataAccountsServicesWebdisk.from_dict(obj["webdisk"]) if obj.get("webdisk") is not None else None
        })
        return _obj
