...
class StatsManagerSaveConfigurationBody(BaseModel):
    """
    StatsManagerSaveConfigurationBody
    """ # noqa: E501
    changes: Optional[List[StatsManagersaveConfigurationChanges]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": [StatsManagersaveConfigurationChanges.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None
        })
        return _obj
