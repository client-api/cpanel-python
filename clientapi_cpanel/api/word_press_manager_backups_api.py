...
class WordPressManagerBackupsApi:
    ...
    @validate_call
    def word_press_restore_any_running(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._word_press_restore_any_running_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def word_press_restore_any_running_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InlineResponse200573]:
        """Return WordPress site restore status
    ...
    @validate_call
    def word_press_restore_any_running_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _word_press_restore_any_running_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/WordPressRestore/any_running',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def word_press_restore_cleanup(
        self,
        site: Annotated[StrictStr, Field(description="The WordPress site's URL **without** the protocol prefix.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._word_press_restore_cleanup_serialize(
            site=site,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def word_press_restore_cleanup_with_http_info(
        self,
        site: Annotated[StrictStr, Field(description="The WordPress site's URL **without** the protocol prefix.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InlineResponse200574]:
        """Delete restored WordPress site's temporary files
    ...
    @validate_call
    def word_press_restore_cleanup_without_preload_content(
        self,
        site: Annotated[StrictStr, Field(description="The WordPress site's URL **without** the protocol prefix.")],
        _request_timeout: Union[
            None,
    ...
    def _word_press_restore_cleanup_serialize(
        self,
        site,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/WordPressRestore/cleanup',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def word_press_restore_start(
        self,
        backup_path: Annotated[StrictStr, Field(description="The file path to the backup archive.")],
        site: Annotated[StrictStr, Field(description="The WordPress site's URL to restore.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param backup_path: The file path to the backup archive. (required)
        :type backup_path: str
        :param site: The WordPress site's URL to restore. (required)
        :type site: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._word_press_restore_start_serialize(
    ...
    @validate_call
    def word_press_restore_start_with_http_info(
        self,
        backup_path: Annotated[StrictStr, Field(description="The file path to the backup archive.")],
        site: Annotated[StrictStr, Field(description="The WordPress site's URL to restore.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InlineResponse200575]:
        """Restore WordPress site
    ...
    @validate_call
    def word_press_restore_start_without_preload_content(
        self,
        backup_path: Annotated[StrictStr, Field(description="The file path to the backup archive.")],
        site: Annotated[StrictStr, Field(description="The WordPress site's URL to restore.")],
        _request_timeout: Union[
    ...
    def _word_press_restore_start_serialize(
        self,
        backup_path,
        site,
        _request_auth,
        ...
        if backup_path is not None:
            ...
            _query_params.append(('backup_path', backup_path))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/WordPressRestore/start',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
