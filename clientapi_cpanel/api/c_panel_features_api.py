...
class CPanelFeaturesApi:
    ...
    def get_feature_metadata_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InlineResponse200232]:
        """Return cPanel account's features' metadata
    ...
    def _get_feature_metadata_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Features/get_feature_metadata',
    ...
    def has_feature(
        self,
        name: Annotated[StrictStr, Field(description="The feature's name.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The feature's name. (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._has_feature_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def has_feature_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The feature's name.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InlineResponse200233]:
        """Validate cPanel account's feature access
    ...
    @validate_call
    def has_feature_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The feature's name.")],
        _request_timeout: Union[
            None,
    ...
    def _has_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Features/has_feature',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_features_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InlineResponse200234]:
        """Return cPanel account's features
    ...
    def _list_features_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Features/list_features',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
